...
// 初始化
func NewServerV3(name string, cfg *config.TcpConfig) iface.ServerV3 {
	return &ServerV3{
		Name:      name,
...
func (s *ServerV3) Stop() {

}
func (s *ServerV3) Start() {
...
func (s *ServerV3) Serve() {
	s.Start()
	select{}
}

func (s *ServerV3) AddRouter(r iface.IRouter) {
